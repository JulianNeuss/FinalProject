            ...
            <div className="row justify-content-lg-between justify-content-center align-items-center">
              <div className="col-lg-7 col-md-8 col-sm-10">
                <span className="cta-tagline">
                  2 Months Of Experience In Crowdfunding
                </span>
                <h3 className="cta-title">
                  Raise Hand to Support Best Products
                </h3>
              </div>
            ...
            <div className="row justify-content-between">
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="widget about-widget">
                  ...
                  <p>Decentralized crowdfunding </p>
                  ...
                  <ul className="info-list">
                    ...
                    <li>
                      ...
                      <span className="info">
                        ...
                        <a href="#">Recoleta, CABA, Argentina</a>
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="row flex-md-row-reverse">
              ...
              <div className="col-md-6">
                <p className="copyright-text">
                  © 2022 <a href="#">Cryptonate</a>. All Rights Reserved
                </p>
              </div>
            </div>
          </div>
